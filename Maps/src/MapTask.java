...
public class MapTask {
    public static void main(String[] args) {
        ...
        HashMap<String, ru.ifmo.base.lesson15.task.Customer> customerMap = new HashMap<>();
        customerMap.put("1", new ru.ifmo.base.lesson15.task.Customer("Павел", "1", 23));
        customerMap.put("2", new ru.ifmo.base.lesson15.task.Customer("Олег", "2", 17));
        customerMap.put("3", new ru.ifmo.base.lesson15.task.Customer("Максим", "3", 48));
        customerMap.put("4", new ru.ifmo.base.lesson15.task.Customer("Евгения", "4", 67));
